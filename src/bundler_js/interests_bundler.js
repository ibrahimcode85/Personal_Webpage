...
document
  ...
  .setAttribute("src", img_bayanPoolChallenge);
document.getElementById("IMG_0291(1)").setAttribute("src", img_tripJapan);
document
...
document.getElementById("IMG_3610_jpg").setAttribute("src", IMG_3610_jpg);
document.getElementById("IMG_3460_jpg").setAttribute("src", IMG_3460_jpg);
document.getElementById("langkawi1").setAttribute("src", langkawi1);
document.getElementById("langkawi2").setAttribute("src", langkawi2);
document.getElementById("IMG_3293").setAttribute("src", IMG_3293);
document.getElementById("IMG_3155").setAttribute("src", IMG_3155);
document.getElementById("pdClassic1").setAttribute("src", pdClassic1);
document.getElementById("IMG_3048").setAttribute("src", IMG_3048);
document.getElementById("squad_1").setAttribute("src", squad_1);
