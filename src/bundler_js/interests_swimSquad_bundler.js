...
document
  .getElementById("e0cb4eca-3868-40be-a697-e2381a334a02")
  .setAttribute("src", img2);
document.getElementById("IMG_3820").setAttribute("src", img3);
document
  .getElementById("4a3ef765-713d-4a74-9371-c342914e52cb")
  .setAttribute("src", img4);
document.getElementById("IMG_3818").setAttribute("src", img5);
document.getElementById("IMG_3823").setAttribute("src", img6);
