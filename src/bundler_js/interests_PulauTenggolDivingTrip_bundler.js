...
document
  .getElementById("954950d1-dc3e-4a9d-a8d6-6ce12817cc1c")
  .setAttribute("src", img1);
document
  .getElementById("2345c4d7-1ab3-4680-a77d-dc1a3993ba0d")
  .setAttribute("src", img2);
document.getElementById("GOPR0066_adj").setAttribute("src", img3);
document.getElementById("GOPR0072").setAttribute("src", img4);
